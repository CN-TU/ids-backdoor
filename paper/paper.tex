...
After computing the losses, we use $Adam$ optimizer \cite{kingma2014adam} for computing gradients with a learning rate of 0.001.
...
\center
\begin{tabular}{cccc}
\subfloat[CIC-IDS17 (12 layers $\times$ 64 neurons).]{\includegraphics[width = 4in]{figures/multiclass17.pdf}} &
\subfloat[UNSW-NB15 (12 layers $\times$ 64 neurons).]{\includegraphics[width = 3in]{figures/multiclass15.pdf}}
\end{tabular}
