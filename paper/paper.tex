...
In addition to fine-tuning we also tried fine-pruning~\cite{liu_fine-pruning:_2018}, preceding fine-tuning with a large number of different pruning strategies. From these experiments, only pruning a certain fraction of the \gls{mlp}'s first layer resulted in a discernible drop of backdoor efficacy after one epoch of fine-tuning, primarily for \cic{}.
