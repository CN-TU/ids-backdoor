...
\caption{Fine-tuning of the \gls{mui} for \unsw{}: While fine-tuning finally lowers backdoor accuracy a little bit, it takes more training epochs than training the original model.}
