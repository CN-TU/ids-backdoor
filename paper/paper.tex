...
After computing the losses, we use $Adam$ optimizer for computing gradients with a learning rate of 0.001.
...
\midrule
\multirow{6}{*}{\rotatebox{90}{CIC-IDS17}} & \multirow{2}{*}{Equal} & 5 & 0.996 & 0.996 & 0.990 & 0.989 \\
 ...
 & & 3 & 0.997 & 0.997 & 0.990 & 0.990 \\
\midrule
\multirow{6}{*}{\rotatebox{90}{UNSW-NB15}} & \multirow{2}{*}{Equal} & 5 & 0.988 & 0.828 & 0.867 & 0.860 \\
...
\midrule
\multirow{2}{*}{CIC-IDS17} & Binary & 0.983 & 0.988 \\
 & Multiclass & & \\
\midrule
