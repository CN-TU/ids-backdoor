...
To capture similarity between attack families, we in this research experiment with a modified definition of the PDP  (with C being the attack classes):
...
\caption{The solid line shows the median value of the feature for all flows of a specific attack type. The shaded region shows the change in confidence that occurs when the feature is varied.}
