...
\caption{Performance metrics throughout the pruning process for \unsw{}. Considering only harmless leaves and pruning leaves with smaller depth first. The longer the dashes, the higher the fraction of the validation set being used (from 0.01 until 1).}
