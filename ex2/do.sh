...
./learn.py --dataroot "$DATAROOT" --method=rf --function ice --fold 0
./learn.py --dataroot "$DATAROOT" --backdoor --method=rf --function ice --fold 0

./learn.py --dataroot "$DATAROOT" --method=nn --net runs/Jun26*0_3/*.pth --function ice --fold 0
