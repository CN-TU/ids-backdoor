...
\begin{figure*}[p]
\includegraphics[width=0.48\textwidth]{../ice/sourceTransportPort_nn_0.pdf}
\includegraphics[width=0.48\textwidth]{../ice/sourceTransportPort_rf_0.pdf}

\includegraphics[width=0.48\textwidth]{../ice/apply(mean(ipTTL),forward)_nn_0.pdf}
\includegraphics[width=0.48\textwidth]{../ice/apply(mean(ipTTL),forward)_rf_0.pdf}

\includegraphics[width=0.48\textwidth]{../ice/apply(stdev(ipTotalLength),forward)_nn_0.pdf}
\includegraphics[width=0.48\textwidth]{../ice/apply(stdev(ipTotalLength),forward)_rf_0.pdf}
