...
Notably, random forests exhibit a performance which intuitively seems hard or even impossible to achieve.  
This observation motivates taking a closer look at the models' decisions to find out if they  learn to decide based on artifacts from the dataset generation process.
